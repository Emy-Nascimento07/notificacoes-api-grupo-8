...
|---|-------|---------------|---------|-------|-------------------|
| 1 | Membro do grupo faltar por muito tempo | Baixa | Alto | 🟠 | Documentar o código e exigir responsabilidade;
| 2 | Conflitos de merge no Git | Alta | Baixo | 🟡 | Fazer pull antes de trabalhar e utilizar ferramentas como o Live Share; 
| 3 | MySQL não funcionar na máquina de alguém | Média | Médio | 🟠 | Testar config na semana 1 e possuir um computador responsável por isso
| 4 | Tempo insuficiente para todas as features | Baixa | Alto | 🟡 | Priorizar tarefas essenciais
| 5 | Falta de conhecimento técnico em Node.js/Express | Alta | Médio | 🟠 | Estudos antecipados e esforço em conjunto
